...
fn hrv_low_hrv_high_stress_fixture() {
    ...
    let rr: Vec<f64> = vec![
        800.0, 805.0, 795.0, 800.0, 805.0, 795.0, 800.0, 805.0, 795.0, 800.0, 805.0, 795.0,
        800.0, 805.0, 795.0, 800.0, 805.0, 795.0, 800.0, 805.0, 795.0, 800.0, 805.0, 795.0,
        800.0, 805.0, 795.0, 800.0, 805.0, 795.0,
    ];
    let report = compare_hrv_goose_to_reference(&HrvInput {
...
fn hrv_high_hrv_well_recovered_fixture() {
    ...
    let rr: Vec<f64> = vec![
        760.0, 840.0, 760.0, 840.0, 760.0, 840.0, 760.0, 840.0, 760.0, 840.0, 760.0, 840.0,
        760.0, 840.0, 760.0, 840.0, 760.0, 840.0, 760.0, 840.0, 760.0, 840.0, 760.0, 840.0,
        760.0, 840.0, 760.0, 840.0, 760.0, 840.0,
    ];
    let report = compare_hrv_goose_to_reference(&HrvInput {
...
fn hrv_bradycardic_resting_fixture() {
    ...
    let rr: Vec<f64> = vec![
        1330.0, 1340.0, 1320.0, 1330.0, 1340.0, 1320.0, 1330.0, 1340.0, 1320.0, 1330.0,
        1340.0, 1320.0, 1330.0, 1340.0, 1320.0, 1330.0, 1340.0, 1320.0, 1330.0, 1340.0,
        1320.0, 1330.0, 1340.0, 1320.0, 1330.0, 1340.0, 1320.0, 1330.0, 1340.0, 1320.0,
    ];
    let report = compare_hrv_goose_to_reference(&HrvInput {
...
fn hrv_young_age_bracket_fixture() {
    ...
    let rr: Vec<f64> = vec![
        750.0, 770.0, 730.0, 750.0, 770.0, 730.0, 750.0, 770.0, 730.0, 750.0, 770.0, 730.0,
        750.0, 770.0, 730.0, 750.0, 770.0, 730.0, 750.0, 770.0, 730.0, 750.0, 770.0, 730.0,
        750.0, 770.0, 730.0, 750.0, 770.0, 730.0,
    ];
    let report = compare_hrv_goose_to_reference(&HrvInput {
...
fn hrv_older_age_bracket_fixture() {
    ...
    let rr: Vec<f64> = vec![
        800.0, 835.0, 765.0, 800.0, 835.0, 765.0, 800.0, 835.0, 765.0, 800.0, 835.0, 765.0,
        800.0, 835.0, 765.0, 800.0, 835.0, 765.0, 800.0, 835.0, 765.0, 800.0, 835.0, 765.0,
        800.0, 835.0, 765.0, 800.0, 835.0, 765.0,
    ];
    let report = compare_hrv_goose_to_reference(&HrvInput {
