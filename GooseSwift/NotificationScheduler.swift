...
actor NotificationScheduler {
  ...
  func scheduleSleepProcessed(durationMinutes: Int, hrvMS: Double?, recoveryPercent: Double?) async {
  ...
  func scheduleWorkoutDetected(activity: String, durationSeconds: Double, strain: Double?) async {
  ...
  func scheduleBatteryLow(percent: Int) async {
    await schedule(
